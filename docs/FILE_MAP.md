...
| Archivo | Qué hace |
|---|---|
| `test-contratos-api.mjs` | **78 contratos estáticos** frontend ↔ `api/`. Sin red ni credenciales, así que **podría** correr en CI — pero no hay `.github/`: hoy se ejecuta a mano |
