    ...
    <section id="contacto" className="py-20 md:py-28 px-4 sm:px-6 bg-[#080808] w-full">
      <div className="max-w-4xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 mb-12 md:mb-14">
          {items.map((item, i) => (
            ...
            >
              ...
              <p className="text-[color:var(--texto-3)] text-[10px] sm:text-xs tracking-widest uppercase mb-2 relative z-10">{item.label}</p>
        ...
        <div className="text-center mt-7">
          <a
            href="https://www.facebook.com/JardinesClubHipico/"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 text-[color:var(--texto-3)] hover:text-[#C9A84C] text-xs tracking-wide transition-colors"
          >
